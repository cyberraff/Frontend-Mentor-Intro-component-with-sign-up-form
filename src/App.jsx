...
function App() {
	return (
		<>
			<div className=" lg:h-screen bg-[#ff7a7a] pb-24 lg:pb-0 bg-[url('../bg-intro-mobile.png')] bg-no-repeat bg-cover text-white text-center text-2xl lg:bg-[url('../bg-intro-desktop.png')]  lg:flex items-center  ">
